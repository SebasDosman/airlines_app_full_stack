...
@Component({
  selector: 'app-observar-reservas',
  templateUrl: './observar-reservas.component.html',
  styleUrls: ['./observar-reservas.component.css']
})
export class ObservarReservasComponent {
  ...
  obtenerReservasUsuario(){
    ...
    this.reservaServ.obtenerReservasPorUsuario( this.usuario.cedula ).subscribe( reservas =>{
       this.reservasMostrar = reservas.filter( reserva => reserva.estadoPago == "I" && reserva.estado == "A")
